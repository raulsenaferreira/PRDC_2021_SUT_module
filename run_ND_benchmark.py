...
if __name__ == "__main__":
	...
	n_components = 2 #fixo por enquanto, tranformar em array depois
	...
	for model_name, dataset_name, class_to_monitor in zip(model_names, dataset_names, classes_to_monitor):
		...
		for monitor_name in monitor_names:
			...
			if 'isomap' in monitor_name:
				file_isomap = 'isomap_' + str(n_components) + '_components_' + dataset_name + '_class_' + str(monitor.class_to_monitor) + '.p'
